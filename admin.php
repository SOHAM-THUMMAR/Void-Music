...
$result = $con->query("SELECT COALESCE(MAX(id), 0) + 1 as next_id FROM users");
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        echo "<tr>
                ...
                <td align='center'><a href='delete_user.php ? id=".$row["id"]."' class='btn btn-danger btn-sm' onclick='return confirm(\"Are you sure?\")'>Delete</a></td>
              </tr>";
    }
    echo "</table>";
} else {
